...
<div class="modal fade" id="delete-modal" tabindex="-1" role="dialog" aria-
...
label="Fechar"><span aria-hidden="true">&times;</span>
...
dismiss="modal">N&atilde;o</button>
...
type="text" placeholder="Pesquisar Clientes (deixe vazio para trazer todos)">
...
<hr />
<jsp:useBean id="lista" class="to.ListaDeClientes" scope="request" />
<c:if test="${not empty lista}">
<c:if test="${not empty lista.clientes}">
...
class="btn btn-danger btn-xs" data-toggle="modal" data-target="#delete-modal" data-
cliente="${cliente.id }">Excluir</button>
